...
//! account asscociated with the Multisig account, specifying the parameters for a normal solana transaction.
//!
//! To sign, owners should invoke the `approve` instruction, once enough 'approve' is gathered,
//! the `execute_transaction` with the 'Transaction' account.
...
declare_id!("2TgmKJAueFZAG4z6iWXhWC6CkPN8ZrUgbg2CWUkAoUhe");

#[program]
pub mod odf_multisig {
    use super::*;
...
pub struct Approve<'info> {
    // to make sure you do not approve a changed owner and threshold
